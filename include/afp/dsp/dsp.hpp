...
namespace afp::dsp {
  ...
  struct ResampleParams {
    ...
    int quality{8}; ///< KFR resampler quality (0=fast .. N=best; depends on KFR build)
  };
  ...
  public:
    ...
    [[nodiscard]] virtual std::unique_ptr<IPreEmphasis> create_preemphasis() const = 0;

    /** Create resampler (KFR) */
    [[nodiscard]] virtual std::unique_ptr<IResampler> create_resampler() const = 0;
  };
